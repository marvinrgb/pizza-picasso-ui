          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-lg p-6 md:p-8 text-foreground max-w-2xl mx-auto">
            <div className="space-y-4">
              <div className="flex items-center justify-center space-x-2">
                ...
                <p className="text-lg">Musterstraße 123, 12345 Musterstadt</p>
              </div>
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <a href="tel:+49123456789" className="text-lg hover:text-primary transition-colors">
                  +49 (0) 123 456 789
                </a>
              </div>
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <p className="text-lg">
                  <span className="font-medium">Öffnungszeiten:</span> Di-So 17:30 - 22:00 Uhr
                </p>
              </div>
            </div>
          </div>
